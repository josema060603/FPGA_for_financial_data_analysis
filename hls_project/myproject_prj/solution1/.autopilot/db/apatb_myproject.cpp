...
#define AUTOTB_TVOUT_hidden_1_input "../tv/cdatafile/c.myproject.autotvout_hidden_1_input.dat"
#define AUTOTB_TVIN_layer9_out "../tv/cdatafile/c.myproject.autotvin_layer9_out.dat"
...
extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_hidden_1_input, void* __xlx_apatb_param_layer9_out)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_hidden_1_input),
#endif
  };
  port0.param = __xlx_apatb_param_hidden_1_input;
...
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_layer9_out),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_layer9_out),
#endif
  };
  port1.param = __xlx_apatb_param_layer9_out;
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_hidden_1_input, __xlx_apatb_param_layer9_out);
