...
using hls::sim::Byte;
struct __cosim_s300__ { char data[512]; };
struct __cosim_s512__ { char data[512]; };
extern "C" void myproject(volatile void *, volatile void *);
extern "C" void apatb_myproject_hw(volatile void * __xlx_apatb_param_hidden_1_input, volatile void * __xlx_apatb_param_layer9_out) {
using hls::sim::createStream;
  // DUT call
  myproject(__xlx_apatb_param_hidden_1_input, __xlx_apatb_param_layer9_out);
}
